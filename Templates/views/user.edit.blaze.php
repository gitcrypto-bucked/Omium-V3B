...
<body>
    ...
    <div class="main-content"> 
        <div class="container-xl">
            ...
            <form method="post" enctype="multipart/form-data" action="<?=url('/update/users') ?>" autocomplete="off">
            ...
            <?=csrf_token();?>
                ...
                <div class="mb-3">
                    <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" role="switch" id="ativo" name="ativo"<?php if($user['active']=='1') :?> checked <?php endif;?>
                            <label class="form-check-label" for="ativo">Ativo/Inativo</label>
                        </div>
                </div>
                <div class="mb-3">
                    <h6>Permissões  </h6>
                    <?php for($i =0 ; $i < sizeof($perm); $i++) :?>
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" role="switch" id="<?=$perm[$i]?>" name="<?=$perm[$i]?>" <?php if($user_perm[$perm[$i]]=='1') :?> checked <?php endif;?>>
